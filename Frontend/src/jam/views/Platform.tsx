...
function PlatformDescription(): ReactElement {
  return (
    <p style={{ textAlign: "justify", hyphens: "auto" }}>
      Making your game available to players on multiple or specific platforms can increase your
      visibility and give you a higher score. By releasing your game on a variety of platforms, you
      can reach a wider audience and potentially achieve a higher score as more players discover and
      play your game.
    </p>
  );
}
  ...
  return (
    <div className="view" id="Platform">
      ...
      <div className="card-grid">
        ...
        />
        <JsxCard jsx={PlatformDescription()} styleClass={"card card-col-span-4"} />
        <BarChartCard
          data={barData}
