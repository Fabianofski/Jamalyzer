...
function JamDate(jam : jam){
  ...
  return (
    <div>
        This Jam ran from <strong>{format(parseISO(jam.started), 'dd.MM.yyyy')} to {format(parseISO(jam.ended), 'dd.MM.yyyy')},</strong> <br />
  ...
  return (
    <div className="view" id="Overview" style={{backgroundColor: `${jamData.jam.bg_color}`}}>
      ...
      <div className="card-grid">
        ...
        />
        <JsxCard
          jsx={<a href={jamData.jam.twitter.twitter_link} target="_blank" rel="noopener noreferrer">{jamData.jam.twitter.hashtag}</a>}
