  ...
  return (
    <div className="legal-container">
      <div className="legal-view">
        ...
        <p>
          At Jamalyzer, accessible from jamalyzer.com, one of our main priorities is the privacy of
          our visitors. This Privacy Policy document contains types of information that is collected
          and recorded by Jamalyzer and how we use it.
        </p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in Jamalyzer. This
        ...
        <p>
          Jamalyzer follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          Like any other website, Jamalyzer uses &#39;cookies&#39;. These cookies are used to store
        ...
        <p>
          ...
          Jamalyzer, which are sent directly to users&#39; browser. They automatically receive your
        ...
        <p>
          Note that Jamalyzer has no access to or control over these cookies that are used by
        ...
        <p>
          Jamalyzer&#39;s Privacy Policy does not apply to other advertisers or websites. Thus, we
        ...
        <p>
          Jamalyzer does not knowingly collect any Personal Identifiable Information from children
        ...
        <p>
          ...
          us at: <a href="mailto:support@jamalyzer.com">support@jamalyzer.com</a>
        </p>
      </div>
    </div>
  );
