  ...
  return (
    <div className={styles.legalContainer}>
      <div className={styles.legalView}>
        ...
        <p>
          At Jamalyzer, accessible from jamalyzer.com, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Jamalyzer and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Jamalyzer. This policy is not applicable to
        ...
        <p>
          Jamalyzer follows a standard procedure of using log files. These files
        ...
        <p>
          Like any other website, Jamalyzer uses &#39;cookies&#39;. These
        ...
        <p>
          ...
          advertising partners of Jamalyzer.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Jamalyzer, which are sent
        ...
        <p>
          Note that Jamalyzer has no access to or control over these cookies
        ...
        <p>
          Jamalyzer&#39;s Privacy Policy does not apply to other advertisers or
        ...
        <p>
          Jamalyzer does not knowingly collect any Personal Identifiable
