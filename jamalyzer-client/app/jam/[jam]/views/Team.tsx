...
function TeamDescription(): ReactElement {
  return (
    <p style={{ textAlign: "justify", hyphens: "auto" }}>
      Teams with more members are able to create games with a larger amount of
      content and a higher level of quality. By working on a bigger team, you
      may be able to increase the score of your game.
    </p>
  );
}
...
function getTeamStats(jamData: jamData): ReactElement[] {
  ...
  const median = (
    <TeamStat
      ...
      category={"Average:"}
      amount={
        (teamSize / Object.entries(jamData.jam_games).length).toFixed(2) +
        " Members"
      }
    />
  );
